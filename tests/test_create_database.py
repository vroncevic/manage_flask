...
'''
 ...
 Info
     Defined class CreateDatabaseTestCase with attribute(s) and method(s).
     Created test cases for checking functionalities of CreateDatabase.
 Execute
     python3 -m unittest -v test_create_database
'''
...
class CreateDatabaseTestCase(unittest.TestCase):
    '''
        ...
        It defines:
            ...
            :attributes:
                ...
                | db - DB object.
                | create_db - Create database object.
            :methods:
                | setUp - call before test cases.
                | tearDown - call after test cases.
                | test_create_db_check - test create db check.
    '''
    ...
    def setUp(self):
        ...
        self.create_db = CreateDatabase(self.db)

    def tearDown(self):
        '''Call after test cases.'''
        self.create_db = None

    def test_create_db_check(self):
        '''Test create db check.'''
        self.assertEqual(self.create_db is not None, True)
        self.create_db.run()
